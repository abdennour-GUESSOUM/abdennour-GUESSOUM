![Header](https://via.placeholder.com/1200x300/0D1117/FFFFFF?text=Abdennour+GUESSOUM+-+Embedded+Systems+M2) <!-- Remplace par une vraie bannière si tu veux (Canva gratuit) -->
...
**Hardware** : ZedBoard (Zynq-7000) | STM32 | ESP32 | Raspberry Pi | BeagleBone  
**Protocoles** : SPI | I²C | UART | CAN | TCP/IP  

## Projets phares (clique pour voir le code)
